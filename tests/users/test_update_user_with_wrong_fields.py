...
@pytest.mark.parametrize("user_id, username, age, address, accessed_catalog, exp_code", [
...
def test_negative(user_fixture, user_id, username, age, address, accessed_catalog, exp_code):
